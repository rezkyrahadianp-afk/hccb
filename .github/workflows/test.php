...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div class="container">
                <div class="page-header">
                    <h1>New HARRIS Signature Generator</h1>
                </div>
                <form role="form" method="post" target="preview" id="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Title" name="Sender[title]" placeholder="Enter your Job Title">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="HotelName" name="Sender[HotelName]" placeholder="Enter your Hotel Name">
                    </div>
                    <div class="form-group">
                        <label for="Hotel Address">Hotel Address</label>
                        <input type="text" class="form-control" id="HotelAddress" name="Sender[hoteladdress]" placeholder="Enter your Hotel Address">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="HotelEmail" name="Sender[hotelemail]" placeholder="Enter your hotel email address">
                    </div>
                    <div class="form-group">
                        <label for="Hotel Banner URL">Hotel Banner</label>
                        <input type="text" class="form-control" id="HotelBannerURL" name="Sender[hotelbannerurl]" placeholder="Put your hotel code">
        ...
        <div id="footer">
            <div class="container">
                <p class="text-muted credit"><a href="https://tauziahotels.com">TAUZIA Hotel Management © 2021</a></p>
            </div>
        </div>
